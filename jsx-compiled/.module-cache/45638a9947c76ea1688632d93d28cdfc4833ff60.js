...
var TweetListItem = React.createClass({displayName: "TweetListItem",
  locationClick: function(event) {
    var evt = new CustomEvent('twitter:tweetSelected', this.props.tweet);
  ...
  render: function() {
    ...
    if (tweet.geo && tweet.geo.coordinates) {
      mapMarker = React.createElement("a", {className: "fa fa-map-marker map-marker", onClick: this.locationClick, href: true})
    }
