...
var TweetListItem = React.createClass({displayName: "TweetListItem",
  render: function() {
    return (
      ...
      React.createElement("span", {className: "text", dangerouslySetInnerHTML: {__html: linkify(this.props.tweet.text) + ' '}}), 
      ...
      React.createElement("i", {className: "fa fa-map-marker map-marker"})
      )
    );
  }
});
